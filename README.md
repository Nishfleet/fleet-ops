...
3. **opus-review** — on pull requests and merge-queue builds only. The caller
   job calls `.github/workflows/opus-review.yml`, the grader the five product
   repos reuse (fleet-ops#8621); the reported context is `opus-review /
   opus-review` (ruleset 23692529). A grade below A+ fails the check.
