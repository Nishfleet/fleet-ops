...
# fleet-ops#6032: the named per-class bench writers (quota/overload/hang/
...
# cooldown owns cross-run seat skipping. mark_seat_spawn_fail and
# mark_seat_empty_run above are the real marker writers.
