...
mark_seat_empty_run() {
    ...
    # avoid punishing a healthy remote seat. The long failure-ceiling park
    # (SEAT_FAILURE_CEILING, default 20, to SEAT_PARK_WALL_S, default 24 h)
...
mark_seat_quota_bench() {
    ...
    # ~15min default). Recompute bench_until so the bench branch in seat_usable
    # holds the effective wall.
