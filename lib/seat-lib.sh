...
# from worker_memory.<repo> (0509 2.5G, fleet-ops 2.5G since #3885, heavy 1.0G), converted to
...
# fleet-ops worker (2.5 GB, fleet-ops#3885) charges 1.25 units instead of the flat 1
