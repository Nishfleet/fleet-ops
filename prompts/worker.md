...
- `run-proof:` (units/timers/workflows) via `bin/prove-one-run-check`. Armed without ran fails (fleet-ops#378). Every worker PR needs `Verification:` or `run-proof:`; run `bin/fleet-exec-review-canary --body <pr-body-file>`.
