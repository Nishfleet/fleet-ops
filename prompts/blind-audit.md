...
Enumerate (or confirm) every hand-performed operation since the
manual-seam window start listed in Context below, using the evidence
JSON in Context below. Sources:
