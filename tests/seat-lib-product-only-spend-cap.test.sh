<<<<<<< HEAD
#!/usr/bin/env bash
# fleet-ops#4263 P3b: listed in ci.yml (workers cannot edit workflows). The product_only paid-seat USD/day cap was a picker rule; the LiteLLM proxy routes no such deployment.
...
ok "product-only spend-cap retired with the picker"
||||||| (empty tree)
=======
#!/usr/bin/env bash
