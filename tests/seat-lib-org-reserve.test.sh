<<<<<<< HEAD
#!/usr/bin/env bash
# fleet-ops#4263 P3b: listed in ci.yml (workers cannot edit workflows). The org-reserve AIMD path was deleted with the routing library.
...
ok "org-reserve path retired with the picker"
||||||| (empty tree)
=======
#!/usr/bin/env bash
