...
#      assembles into 0509 packets, fleet-ops#3247) keeps the D1 schema rule
#      (expand/contract) needles.
...
# Needles from the d1-gate-integrity.md fragment D1 schema rule. Removing any
# of these would let an agent drop a hard migration safeguard without CI
# failing loud.
needles=(
...
check_worker "$worker" || fail "d1-gate-integrity.md missing one or more D1 schema needles"
ok "scenario1: d1-gate-integrity.md contains the D1 schema rule needles"
