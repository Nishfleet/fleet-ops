<<<<<<< HEAD
#!/usr/bin/env bash
# fleet-ops#4263 P3b: listed in ci.yml (workers cannot edit workflows). Degraded-mode picking lived in the deleted routing library.
...
ok "routing library no longer defines the retired picker"
||||||| (empty tree)
=======
#!/usr/bin/env bash
