...
write_dispatch_ledger() {  # $1=dispatch uuid (alert `dispatch` label), $2=unit, $3=packet_path
...
write_dispatch_ledger "$UUID_A" "$UNIT_A" "$scratch/packet-a.md"
reset_logs
...
write_dispatch_ledger "$UUID_B" "$UNIT_B" "$scratch/packet-pr-candidate.md"
reset_logs
...
write_dispatch_ledger "$UUID_C" "$UNIT_C" "$scratch/packet-pr-candidate.md"
reset_logs
