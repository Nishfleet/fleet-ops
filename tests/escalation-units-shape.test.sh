...
grep -qF 'chain-e2e-drill-fixture*' "$unit_write" \
  || fail "unit-escalation-write: must exclude chain-e2e-drill-fixture* (#375 drill fixture; #6734 burned a worker seat per heartbeat spin)"
