...
#   (n) seven-requirement packet (today's evidence shape) bounces.
#   (o) accept: lines do not count as required:.
#   (p) intake bounce replay flips labels and comments split me.
