...
[[ "$prepaid_order" == "ollama devin cline cursor xai-oauth runinfra" ]] \
  || fail "prepaid order must be 'ollama devin cline cursor xai-oauth runinfra', got: $prepaid_order"
...
ok "prepaid order ollama devin cline cursor xai-oauth runinfra; devin cap carries a dated reason, class prepaid-quota"
