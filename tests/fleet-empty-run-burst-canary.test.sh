...
# Seat-health stub for healthy-vs-faulted classification.
seat_health="$scratch/pi-seat-health.json"
export FLEET_EMPTY_BURST_SEAT_HEALTH="$seat_health"
...
[2026-09-01T14:11:19Z] empty-run: marked openrouter/deepseek/deepseek-v4-flash-0731 unusable until 2026-09-01T14:26:19Z (reason=pi-issue:fleet-ops-2627:provider-no-op:stdout=0B, backoff=900s, count=1)
"
write_seat_health <<'JSON'
{
  "seats": [
    {
      "id": "openrouter__deepseek_deepseek-v4-flash-0731",
      "provider": "openrouter",
...
"
write_err "fleet-ops-bench"    "[2026-09-01T01:00:00Z] pi-issue-run: fleet-ops-bench pi exited 0 but stdout=0B (< 20B) — provider no-op
[2026-09-01T01:00:00Z] empty-run: marked openrouter/deepseek/deepseek-v4-flash-0731 unusable until 2026-09-01T01:15:00Z (reason=pi-issue:fleet-ops-bench:provider-no-op:stdout=0B, backoff=900s, count=1)
"
...
write_seat_health <<'JSON'
{
  "seats": [
    {
      "id": "straitly__deepseek_deepseek-v4-pro",
      "provider": "straitly",
...
write_seat_health <<'JSON'
{
  "seats": [
    {
      "id": "opencode__nemotron-3-ultra-free",
      "provider": "opencode",
