...
grep -F 'bin/fleet-completion-canary /home/nish/.local/bin/fleet-completion-canary' "$manifest" >/dev/null \
...
echo "OK: fleet-completion-canary: stall ladder, green cycle, skip-list, ue observe"
